...
public class AssetLoader {
    ...
    public static TextureRegion logo, zbLogo, bg, grass, bird, birdDown, birdUp, skullUp, skullDown, bar, playButtonUp,
            playButtonDown, ready, gameOver, highScore, scoreboard, star, noStar, retry;
    ...
    public static void load() {
        ...
        texture = new Texture(Gdx.files.internal("data/texture.png"));// modified
                                                                      // texture.png
